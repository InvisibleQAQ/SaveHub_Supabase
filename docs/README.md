...
7. ✅ 参考[常见任务](./06-common-tasks.md) 和 [高级任务](./06-advanced-tasks.md)，尝试写代码

### 实战路径（第三天起）

8. 🔥 挑选一个功能需求
9. 🔥 参考[常见任务](./06-common-tasks.md) 和 [高级任务](./06-advanced-tasks.md) 找相似示例
...
- **参考基础示例** → [常见任务](./06-common-tasks.md)
- **参考高级示例** → [高级任务](./06-advanced-tasks.md)
